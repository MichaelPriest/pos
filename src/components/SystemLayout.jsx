...
const groups = [
  ...
  { label:'Comercial', icon:'🛍️', open:true, links:[['/admin?tab=Produtos','📦','Produtos'],['/admin?tab=Estoque','🏷️','Estoque'],['/admin?tab=Pedidos','🧾','Pedidos'],['/admin?tab=Logística','🚚','Logística'],['/admin?tab=Cupons','🎟️','Cupons']] },
  { label:'Operação', icon:'⚙️', open:true, links:[['/pdv','🛒','Frente de caixa'],['/caixa','💵','Controle de caixa'],['/financeiro','💳','Financeiro'],['/relatorios','📊','Relatórios']] },
